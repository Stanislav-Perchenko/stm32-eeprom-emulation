...
/* EEPROM library not initialized */
#define EE_NOT_INITIALIZED		((uint16_t)0x00AA)
...
/* Variable read result (found or not) */
#define EE_VAR_FOUND			((uint16_t)0x0000)
#define EE_VAR_NOT_FOUND		((uint16_t)0x0001)
